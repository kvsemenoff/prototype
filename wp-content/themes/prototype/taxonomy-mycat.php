        ...
        <div>
            ...
            <div class="service_i_top clearfix">
                ...
                <div class="service_i_txt">
                    ...
                    <p>
                        <?php //echo get_field('service_caption'); ?>
                    </p>
                    <!-- Введите здесь короткое описание услуги. Выберите визитку, которую вы хотели бы заказать из предложенных ниже. Если не нашли подходящую – позвоните нам или отправьте сообщение через форму, расположенную внизу страницы. -->
                </div>
            </div>
                        ...
                        <div class="ser_i_link">
                            ...
                            <div class="ser_i_txt">
                                ...
                                <ul>
                                    ...
                                    <?php echo get_field('short_li_title_for_services'); ?>
                                </ul>
                            </div>
