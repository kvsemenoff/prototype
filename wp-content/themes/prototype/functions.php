...
add_action('init', 'history_register');
function history_register() {
    $args = array(
        'label'               => __('История'),
        'labels'              => array(
            'name'               => __('История'),
            'singular_name'      => __('История'),
            'menu_name'          => __('История'),
            'all_items'          => __('Все истории'),
            'add_new'            => _x('Добавить историю', 'talk'),
            'add_new_item'       => __('Новая история'),
            'edit_item'          => __('Редактировать историю'),
            'new_item'           => __('Новая история'),
            'view_item'          => __('История'),
            'not_found'          => __('История не найдена'),
            'not_found_in_trash' => __('Удаленных историй нет'),
            'search_items'       => __('Найти историю')
        ),
        'description'         => __('История'),
        'public'              => true,
...
function special_nav_class ($classes, $item) {
    if (in_array('current-menu-item', $classes) ){
        $classes[] = 'tech_menu_active dg-cost';
    }
    return $classes;
}
/**
